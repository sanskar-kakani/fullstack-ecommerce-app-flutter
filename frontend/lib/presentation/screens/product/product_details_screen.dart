      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            // Text("${widget.productModel.title}", style: TextStyles.heading3, textAlign: TextAlign.center,),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(Formatter.formatPrice(widget.productModel.price!), style: TextStyles.heading3,),
                      const GapWidget(),
                      Text(
                        Formatter.formatPrice(widget.productModel.price!*1.57),
